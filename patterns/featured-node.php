...
<div class="wp-block-group wpamesh-right-widget">
...
<div class="wp-block-group wpamesh-featured-node">

<!-- wp:paragraph {"className":"node-name"} -->
<p class="node-name">RoadsEnd Tower</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"className":"node-role"} -->
<p class="node-role">Infrastructure &middot; Repeater</p>
<!-- /wp:paragraph -->
